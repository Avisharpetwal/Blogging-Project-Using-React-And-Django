...
//   // Filtered blogs (null-safe for category)
...
//           {user && (
//             <button className="btn btn-success mb-3 w-100" onClick={() => navigate('/blogs/new')}>
//               Add Blog
//             </button>
//           )}
...
//                   <button className="btn btn-primary btn-sm" onClick={() => handleReadMore(blog.id)}>
//                     Read More
//                   </button>

//                   {user && blog.author.id === user.id && (
//                     <>
//                       <button className="btn btn-warning btn-sm ms-2" onClick={() => navigate(`/blogs/edit/${blog.id}`)}>
//                         Edit
//                       </button>
